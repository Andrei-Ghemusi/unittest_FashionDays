...
class NonFunctionalTestsMainPage(TestCase):
    ...
    def generate_lighthouse_report(cls):
        ...
        report_path = os.path.join(base_path, 'reports', 'main_page_lighthouse_report.html')

        lighthouse_command: str = f"lighthouse --throttling.cpuSlowdownMultiplier=3 https://www.fashiondays.ro/ --output=html --quiet --output-path={report_path}"
    ...
    def get_html_report(self):
        ...
        report_path = os.path.join(script_dir, '..', 'reports', 'main_page_lighthouse_report.html')
